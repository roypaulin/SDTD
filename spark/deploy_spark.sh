...
cp ${SPARK_DIR}/SDTD-assembly-1.0.jar .
...
${SPARK_SUBMIT} \
   ...
   --conf spark.kubernetes.container.image=${DOCKER_USER}/spark:${TIMESTAMP} \
   --conf spark.kubernetes.namespace=default \
   --conf spark.kubernetes.authenticate.driver.serviceAccountName=spark \
    local:///opt/spark/jars/SDTD-assembly-1.0.jar > spark_submit.log &
