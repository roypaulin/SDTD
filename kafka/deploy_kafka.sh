...
if [ ! -d ${BASE_DIR}/spark/twitter/src/main/scala/SDTD ]; then
  mkdir -p ${BASE_DIR}/spark/twitter/src/main/scala/SDTD >/dev/null 2>&1
fi

# Moving scala file created by ansible to good folder to build jar file
mv  twitter-subscriber.scala ${BASE_DIR}/spark/twitter/src/main/scala/SDTD
